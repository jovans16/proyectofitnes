...
public class AbdomenAdapter extends BaseAdapter {
    private Context context;
    private List<AbdomenExercise> exercises;

    public AbdomenAdapter(Context context, List<AbdomenExercise> exercises) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_abdomen, parent, false);
        }

        AbdomenExercise exercise = exercises.get(position);

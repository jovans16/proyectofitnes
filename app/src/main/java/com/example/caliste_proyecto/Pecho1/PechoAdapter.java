...
public class PechoAdapter extends BaseAdapter {

    private Context context;
    private List<PechoExercise> exercises;

    public PechoAdapter(Context context, List<PechoExercise> exercises) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_pecho, parent, false);
        }

        PechoExercise exercise = exercises.get(position);

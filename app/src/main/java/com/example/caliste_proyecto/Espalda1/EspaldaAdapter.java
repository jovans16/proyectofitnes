...
public class EspaldaAdapter extends BaseAdapter {

    private Context context;
    private List<EspaldaExercise> exercises;

    public EspaldaAdapter(Context context, List<EspaldaExercise> exercises) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_espalda, parent, false);
        }

        EspaldaExercise exercise = exercises.get(position);

...
public class ejercicioAdapter extends BaseAdapter {
    ...
    public ejercicioAdapter(Context context, List<Exercise> exercises) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_ejercicio, parent, false);
        }
        ...
        titulo.setText(exercise.getName());

        TextView repeticiones = convertView.findViewById(R.id.numeroRepeticiones);
        repeticiones.setText("Repeticiones: " + exercise.getRepetitions());

        ImageView imagen = convertView.findViewById(R.id.fotoejer);

        if (exercise.getImagen_url() != null && !exercise.getImagen_url().isEmpty()) {
            Glide.with(context)
                    .load(exercise.getImagen_url())
